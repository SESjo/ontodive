---
title: "Data Exploration NES (1/2) - 2018"
...
pkgdown:
  as_is: false
vignette: >
  %\VignetteIndexEntry{Northern Elephant Seals - 2018 (1/2)}
...
#### Before {-}
```{r data-exploration-2018-8, fig.cap='Distribution of `dduration` for each seal. The dashed line highlight the "subjective" threshold used to remove outliers (3000 sec)', fig.height=5}
ggplot(
  rbind(
...
```{r data-exploration-2018-15, results='asis', cache=FALSE, echo=FALSE}
for (i in names_display) {
  cat("####", i, "{.unlisted .unnumbered} \n")
  if (i == "driftrate") {
    print(
...
```{r data-exploration-2018-17, results='asis', cache=FALSE, echo=FALSE}
# same plot with a colored for the phase of the day
for (i in names_display) {
  cat("####", i, "{-} \n")
  print(
...
```{r data-exploration-2018-21, results='asis', cache=FALSE, echo=FALSE}
for (i in names_display) {
  cat("####", i, "{.unlisted .unnumbered} \n")
  print(
    ggplot(
